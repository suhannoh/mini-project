...
public interface CommentRepository extends JpaRepository <Comment , Long> {
    ...
    @Query("""
        select new com.example.backend.post_comment.dto.read.readCommentResponse(
            c.id, u.id , u.name, c.comment , c.createdAt
        )
        from Comment c
        ...
        order by c.id asc
    """)
    List<readCommentResponse> findCommentResponsesByPostId(@Param("postId") Long postId);
